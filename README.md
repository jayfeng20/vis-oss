...
generates is mainly for helping contributors familiarize themselves with any issue faster, and is not meant
to "generate the right solution for the issue".
